...
export const SKINS: SkinItem[] = [
  ...
  // ---- Country skins ----
  {
    ...
    price: 1000,
    color: "#00247d",
    flag: { type: "ensign", colors: ["#00247d"], accent: "#ffffff" },
  },
  {
    id: "flag-nz",
    name: "New Zealand",
    price: 1000,
    color: "#00247d",
    flag: { type: "ensign", colors: ["#00247d"], accent: "#cc142b", accent2: "nz" },
  },
  {
    id: "flag-us",
    name: "United States",
    ...
    flag: {
      type: "canton",
      colors: ["#b22234", "#ffffff", "#b22234", "#ffffff", "#b22234", "#ffffff"],
      accent: "#3c3b6e",
      accent2: "#ffffff",
    },
  },
  {
    ...
    price: 1000,
    color: "#00247d",
    flag: { type: "cross", colors: ["#00247d"], accent: "#cf142b", accent2: "#ffffff" },
  },
  {
    id: "flag-fr",
    name: "France",
    price: 1000,
    color: "#0055a4",
    flag: { type: "vbands", colors: ["#0055a4", "#ffffff", "#ef4135"] },
  },
  {
    id: "flag-it",
    name: "Italy",
    price: 1000,
    color: "#008c45",
    flag: { type: "vbands", colors: ["#008c45", "#f4f5f0", "#cd212a"] },
  },
  {
    id: "flag-ie",
    name: "Ireland",
    price: 1000,
    color: "#169b62",
    flag: { type: "vbands", colors: ["#169b62", "#ffffff", "#ff883e"] },
  },
  {
    id: "flag-be",
    name: "Belgium",
    price: 1000,
    color: "#000000",
    flag: { type: "vbands", colors: ["#000000", "#fdda24", "#ef3340"] },
  },
  {
    id: "flag-ro",
    name: "Romania",
    price: 1000,
    color: "#002b7f",
    flag: { type: "vbands", colors: ["#002b7f", "#fcd116", "#ce1126"] },
  },
  {
    id: "flag-de",
    name: "Germany",
    price: 1000,
    color: "#000000",
    flag: { type: "bands", colors: ["#000000", "#dd0000", "#ffce00"] },
  },
  {
    id: "flag-nl",
    name: "Netherlands",
    price: 1000,
    color: "#ae1c28",
    flag: { type: "bands", colors: ["#ae1c28", "#ffffff", "#21468b"] },
  },
  {
    id: "flag-ru",
    name: "Russia",
    price: 1000,
    color: "#ffffff",
    flag: { type: "bands", colors: ["#ffffff", "#0039a6", "#d52b1e"] },
  },
  {
    id: "flag-es",
    name: "Spain",
    price: 1000,
    color: "#aa151b",
    flag: { type: "bands", colors: ["#aa151b", "#f1bf00", "#f1bf00", "#aa151b"] },
  },
  {
    id: "flag-pt",
    name: "Portugal",
    price: 1000,
    color: "#046a38",
    flag: { type: "vbands", colors: ["#046a38", "#046a38", "#da291c", "#da291c", "#da291c"] },
  },
  {
    id: "flag-pl",
    name: "Poland",
    price: 1000,
    color: "#ffffff",
    flag: { type: "bands", colors: ["#ffffff", "#dc143c"] },
  },
  {
    id: "flag-ua",
    name: "Ukraine",
    price: 1000,
    color: "#0057b7",
    flag: { type: "bands", colors: ["#0057b7", "#ffd700"] },
  },
  {
    id: "flag-id",
    name: "Indonesia",
    price: 1000,
    color: "#ce1126",
    flag: { type: "bands", colors: ["#ce1126", "#ffffff"] },
  },
  {
    id: "flag-ar",
    name: "Argentina",
    price: 1000,
    color: "#74acdf",
    flag: { type: "circle", colors: ["#74acdf", "#ffffff", "#74acdf"], accent: "#f6b40e" },
  },
  {
    id: "flag-jp",
    name: "Japan",
    price: 1000,
    color: "#ffffff",
    flag: { type: "circle", colors: ["#ffffff"], accent: "#bc002d" },
  },
  {
    id: "flag-bd",
    name: "Bangladesh",
    price: 1000,
    color: "#006a4e",
    flag: { type: "circle", colors: ["#006a4e"], accent: "#f42a41" },
  },
  {
    id: "flag-in",
    name: "India",
    price: 1000,
    color: "#ff9933",
    flag: { type: "circle", colors: ["#ff9933", "#ffffff", "#138808"], accent: "#000080" },
  },
  {
    id: "flag-kr",
    name: "South Korea",
    price: 1000,
    color: "#ffffff",
    flag: { type: "circle", colors: ["#ffffff"], accent: "#cd2e3a" },
  },
  {
    id: "flag-br",
    name: "Brazil",
    price: 1000,
    color: "#009c3b",
    flag: { type: "diamond", colors: ["#009c3b"], accent: "#ffdf00", accent2: "#002776" },
  },
  {
    id: "flag-se",
    name: "Sweden",
    price: 1000,
    color: "#006aa7",
    flag: { type: "cross", colors: ["#006aa7"], accent: "#fecc00" },
  },
  {
    id: "flag-no",
    name: "Norway",
    price: 1000,
    color: "#ba0c2f",
    flag: { type: "cross", colors: ["#ba0c2f"], accent: "#00205b", accent2: "#ffffff" },
  },
  {
    id: "flag-fi",
    name: "Finland",
    price: 1000,
    color: "#ffffff",
    flag: { type: "cross", colors: ["#ffffff"], accent: "#003580" },
  },
  {
    id: "flag-dk",
    name: "Denmark",
    price: 1000,
    color: "#c60c30",
    flag: { type: "cross", colors: ["#c60c30"], accent: "#ffffff" },
  },
  {
    id: "flag-is",
    name: "Iceland",
    price: 1000,
    color: "#02529c",
    flag: { type: "cross", colors: ["#02529c"], accent: "#dc1e35", accent2: "#ffffff" },
  },
  {
    id: "flag-ch",
    name: "Switzerland",
    price: 1000,
    color: "#d52b1e",
    flag: { type: "cross", colors: ["#d52b1e"], accent: "#ffffff" },
  },
  {
    id: "flag-gr",
    name: "Greece",
    price: 1000,
    color: "#0d5eaf",
    flag: { type: "bands", colors: ["#0d5eaf", "#ffffff", "#0d5eaf", "#ffffff", "#0d5eaf"] },
  },
  {
    id: "flag-ng",
    name: "Nigeria",
    price: 1000,
    color: "#008751",
    flag: { type: "vbands", colors: ["#008751", "#ffffff", "#008751"] },
  },
  {
    id: "flag-mx",
    name: "Mexico",
    price: 1000,
    color: "#006847",
    flag: { type: "vbands", colors: ["#006847", "#ffffff", "#ce1126"] },
  },
  {
    id: "flag-ca",
    name: "Canada",
    price: 1000,
    color: "#ff0000",
    flag: { type: "vbands", colors: ["#ff0000", "#ffffff", "#ff0000"] },
  },
  {
    id: "flag-tr",
    name: "Turkey",
    price: 1000,
    color: "#e30a17",
    flag: { type: "circle", colors: ["#e30a17"], accent: "#ffffff" },
  },
  {
    id: "flag-cz",
    name: "Czechia",
    price: 1000,
    color: "#ffffff",
    flag: { type: "diagonal", colors: ["#ffffff", "#d7141a"] },
  },
  {
    id: "flag-za",
    name: "South Africa",
    price: 1000,
    color: "#007a4d",
    flag: { type: "diagonal", colors: ["#007a4d", "#ffb612"] },
  },
];
...
export const EXPLOSIONS: ExplosionItem[] = [
  { id: "none", name: "None", price: 0, kind: "shockwave", colors: ["#ffffff"] },
  {
    ...
    price: 4500,
    kind: "confetti",
    colors: ["#ff4d4d", "#4d94ff", "#ffd24d", "#4dff88", "#e04dff"],
  },
  {
    id: "emoji-party",
    name: "Party Emojis",
  ...
  { id: "emoji-egg", name: "Egg Storm", price: 7500, kind: "emoji", emojis: ["🥚", "🍳", "🐣"] },
  {
    ...
    price: 10500,
    kind: "firework",
    colors: ["#ffd24d", "#ff4d4d", "#4dd2ff", "#ffffff"],
  },
  {
    id: "shock-gold",
    name: "Gold Shockwave",
  ...
  },
  {
    ...
    price: 21000,
    kind: "blast",
    colors: ["#ffcf4d", "#ff7a1a", "#ff3b30", "#4a4a4a"],
  },
  {
    id: "blackhole",
    name: "Black Hole",
